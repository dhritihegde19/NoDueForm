...
class DueForm(FlaskForm):
    ...
    department = SelectField('Department', choices=[('CSE', 'Computer Science Engineering'), ('ISE', 'Information Science Engineering'), ('Other', 'Other')], validators=[DataRequired()], render_kw={"style": "font-size:30px"})
